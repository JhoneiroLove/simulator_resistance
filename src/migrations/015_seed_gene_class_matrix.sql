...
INSERT INTO gene_class_multipliers (gen, clase_antibiotica, multiplicador_mic) VALUES
...
-- WHERE clase_antibiotica='carbapenemicos' AND multiplicador_mic > 1
...
-- SELECT gen, multiplicador_mic FROM gene_class_multipliers
-- WHERE clase_antibiotica='fluoroquinolonas' AND multiplicador_mic > 1
-- ORDER BY multiplicador_mic DESC;
...
-- JOIN antibiotic_classes a ON a.clase = g.clase_antibiotica
